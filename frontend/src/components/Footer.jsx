...
const Footer = () => {
    return (
        <div className=" container bg-white py-12 px-4">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8  max-w-6xl mx-auto">
                <div className="space-y-4">
                    <h3 className="bg-white font-semibold text-black text-sm mb-3">DiabetesAI Predictor</h3>
                    <p className="bg-white text-gray-500 text-base">Machine learning powered diabetes risk assessment tool using evidence-based health indicators.</p>
                    <div className="flex  flex-wrap bg-white gap-2 space-y-2 font-medium">
                ...
                {/* Project data source */}
                <div className="space-y-4 ">
                    <h4 className="bg-white font-semibold text-black text-sm">Resources</h4>
                    <div>
                ...
                {/* Stack */}
                <div className="space-y-4">
                    <h4 className="bg-white font-semibold text-black text-sm">Technical Stack</h4>
                    <div>
